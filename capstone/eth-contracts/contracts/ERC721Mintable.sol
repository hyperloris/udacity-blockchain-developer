...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Owner can not approve himself");
        require(msg.sender == owner || isApprovedForAll(owner, to), "Caller is not approved"); 
...
contract PropertyToken is ERC721Metadata("PropertyToken", "PTK", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
