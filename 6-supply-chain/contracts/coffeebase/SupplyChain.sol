    ...
    RetailerRole
{
    ...
    modifier checkValue(uint256 _upc) {
        ...
        address payable buyer = makePayable(msg.sender);
    ...
    function kill() public onlyOwner {
        address payable payableOwner = makePayable(owner());
        ...
        checkValue(_upc)
    {
        ...
        address payable payableFarmer = makePayable(item.originFarmerID);
        payableFarmer.transfer(item.productPrice);
